...
<div class="container">
  <nav class="navbar navbar-expand-lg my-navbar p-0">
     <a class="navbar-brand" href="index.php"><img src="img/logo1.png" class="img-fluid"/></a>
    ...
    <ul class="navbar-nav ml-auto">
	  ...
	  <li class="nav-item dropdown">
        <a class="nav-link" href="#" data-toggle="dropdown">Services <i class="fas fa-chevron-down"></i></a>
		  <ul class="dropdown-menu small-menu">
		     <a href="urban-infrastructure.php">Sisal Processing</a>
		     <a href="road-infrastructure.php">Ropes Mkaing</a>
		     <a href="industrial-infrastructure.php">Fibre Grading</a>
		     <a href="construction-engineering.php">Mat Making</a>
		     <a href="structure-engineering.php">Avocado Planting</a>

		  </ul>
      </li>

	   <li class="nav-item dropdown">
        <a class="nav-link" href="#" data-toggle="dropdown">Community <i class="fas fa-chevron-down"></i></a>
		  <ul class="dropdown-menu small-menu">
